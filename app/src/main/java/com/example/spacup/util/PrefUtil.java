package com.example.spacup.util;
...
// PassCodeLock 에 관련된 util(Package)
...
public class PrefUtil {
    ...
    private static SharedPreferences getSharedPreferences() {
        if (shPref == null) shPref = MyApp.getInstance().getSharedPreferences(MyApp.getInstance().getPackageName(), Context.MODE_PRIVATE);
        return shPref;
    }
